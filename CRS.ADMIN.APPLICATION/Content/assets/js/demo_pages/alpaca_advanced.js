...
var AlpacaAdvanced = function() {
    ...
    var _componentAlpacaAdvanced = function() {
        ...
        $('#alpaca-option-tree-connector').alpaca({
            schemaSource: '/Content/assets/demo_data/alpaca/optiontree-custom-schema.json',
            optionsSource: '/Content/assets/demo_data/alpaca/optiontree-custom-options.json',
            options: {
                focus: false
            }
        });
