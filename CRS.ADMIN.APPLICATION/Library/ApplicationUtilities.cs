        ...
        public static object LoadDropdownList(string ForMethod, string search1 = "", string search2 = "")
        {
            ...
            switch (ForMethod.ToUpper())
            {
                ...
                case "DISCOUNTCATEGORY":
                    dbResponse = _CommonBuss.GetDropDown("064", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                ...
                case "LOCATIONDDL":
                    ...
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "BUSINESSTYPEDDL":
                    dbResponse = _CommonBuss.GetDropDown("018", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "BLOODGROUPDDL":
                    dbResponse = _CommonBuss.GetDropDown("019", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "OCCUPATIONDDL":
                    dbResponse = _CommonBuss.GetDropDown("020", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "RANKDDL":
                    dbResponse = _CommonBuss.GetDropDown("021", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "LIQUORSTRENGTHDDL":
                    dbResponse = _CommonBuss.GetDropDown("022", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "ZODIACSIGNSDDL":
                    dbResponse = _CommonBuss.GetDropDown("023", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "CLUBSTOREDDL":
                    dbResponse = _CommonBuss.GetDropDown("027", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "CLUBCATEGORYDDL":
                    dbResponse = _CommonBuss.GetDropDown("024", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "ROLEDDL":
                    dbResponse = _CommonBuss.GetDropDown("025", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "USERTYPEDDL":
                    dbResponse = _CommonBuss.GetDropDown("028", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "USERLISTVIATYPEDDL":
                    dbResponse = _CommonBuss.GetDropDown("029", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "DISPLAYORDERDDL":
                    ...
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "GROUPDDLBYLOCATIONID":
                    dbResponse = _CommonBuss.GetDropDown("031", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "DISPLAYPAGEORDERDDL":
                    dbResponse = _CommonBuss.GetDropDown("032", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "HOSTDDLBYCLUBID":
                    ...
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "COMMISSIONCATEGORYVIACLUBDDL":
                    dbResponse = _CommonBuss.GetDropDown("034", search1, search2);
                    dbResponse.ForEach(item => { response.Add(item.Key.EncryptParameter(), item.Value); });
                    return response;
                case "CLUBSCHEDULE":
                ...
                case "CLOSINGDATE":
                    ...
                    return response;
                case "COUNTRYCODE":
                    dbResponse = _CommonBuss.GetDropDown("048", search1, search2);
